...
class ProductRepositoryImpl with HandleResponse implements ProductRepository {
  ...
  Future<DataState<List<Category>, Exception>> getCategories(
    ...
    final response = await handleResponse(
        ...
        fromJson: (json) => (json as List<dynamic>).map(
  ...
  @override
  Future<DataState<CategoryProduct, Exception>> deleteCategoryToProduct(
    ...
    final response = await handleResponse(
        ...
        fromJson: (json) => (json as List<dynamic>).map(
              (e) => CategoryProductDto.fromJson(e as Map<String, dynamic>),
            ));
